  ...
  function sb(a, b, c) {
    ...
    if (c)
      for (b = 0; b < c.length; b++)
        if (((a = c[b]), a < this.i))
          (a += this.h),
            (d = this.m[a]) ? Array.isArray(d) && $a(d) : (this.m[a] = db);
        else {
          ...
          for (var f = [], h = null, k, l, m; e < d; )
            (k = a[e++]),
              128 > k
                ...
                : L(),
              8192 <= f.length && ((h = wa(h, f)), (f.length = 0));
          g = wa(h, f);
        }
        W(b, c, g);
        return !0;
    ...
    return J(function (p) {
      switch (p.g) {
        ...
        case 2:
          ...
          if ("object" === typeof window)
            return (
              Dc("createMediapipeSolutionsWasm", { locateFile: a.locateFile }),
                ...
                return J(function (w) {
                  if (1 == w.g)
                    return (
                      ...
                      (r = window.createMediapipeSolutionsPackedAssets),
                      (t = a),
                      G(w, n(r), 2)
                    );
                  t.h = w.h;
